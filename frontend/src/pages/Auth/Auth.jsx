                ...
                <div className={styles["auth-signin-signup"]}>
                    ...
                    <form onSubmit={handleRegClick} className={styles["auth-sign-up-form"]}>
                        ...
                        <div className={styles["auth-input-field"]}>
                            ...
                            <input type="email" onChange={(e)=>setRemail(e.target.value)} value={remail} placeholder="Email"/>
                        </div>
                        <div className={styles["auth-input-field"]}>
                            <i className="fas fa-user"></i>
                        ...
                        <div className={styles["auth-input-field"]}>
                            <i className="fas fa-lock"></i>
                            <input type="password" onChange={(e)=>setRpassword(e.target.value)} value={rpassword} placeholder="Password"/>
                        </div>
                        <div className={styles["auth-input-field"]}>
                            <i className="fas fa-lock"></i>
